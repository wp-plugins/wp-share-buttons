...
<div class="wrap">
	<?php $path_site2 = plugins_url("../images", __FILE__); ?>
		...
		<div style="float: left;">
			<div><a href="http://huge-it.com/wordpress-plugins-share-buttons-user-manual/" target="_blank">User Manual</a></div>
			<div>This section allows you to configure the Share Buttons options. <a href="http://huge-it.com/wordpress-plugins-share-buttons-user-manual/" target="_blank">More...</a></div>
		</div>
